...
<body class="font-inter bg-gray-950 text-white antialiased overflow-x-hidden">
  <div class="min-h-screen flex flex-col">
    ...
    <section class="relative overflow-hidden bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 px-4 sm:px-6 lg:px-8 pt-12 pb-16 lg:py-24">
      ...
      <div class="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <div class="animate-slide-up animate-delay-600 mx-auto mt-10 lg:mt-12 max-w-md lg:max-w-2xl">
          ...
          <p class="mt-4 text-xs lg:text-sm text-gray-500">No credit card required to start. See the magic for yourself!</p>
        </div>
      </div>
    </section>

    <!-- How It Works Section -->
    <section id="how-it-works" class="py-16 lg:py-24 bg-gray-900">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          ...
          <div class="animate-fade-in-left animate-delay-700 group hover-lift hover:border-green-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/20 text-center border border-gray-700/50 rounded-2xl p-6 backdrop-blur-sm bg-gray-900/30 hover:bg-gray-900/50">
            ...
            <p class="text-sm text-gray-400">Simply drag & drop your event poster (PNG, JPG, or PDF) or select it from your device.</p>
          </div>
          ...
          <div class="animate-slide-up animate-delay-800 border-brand-500/30 hover:border-brand-500/60 hover-lift hover:shadow-2xl hover:shadow-brand-500/30 transition-all duration-500 text-center bg-gradient-to-t from-indigo-500/20 to-purple-600/10 hover:from-indigo-500/30 hover:to-purple-600/20 border rounded-2xl p-6 backdrop-blur-sm group">
            ...
            <p class="text-sm text-gray-400">Our intelligent system analyzes your design, extracts key info, and crafts compelling social media content.</p>
          </div>
          <!-- Step 3: Get Your Content Card -->
          <div class="animate-fade-in-right animate-delay-700 group hover-lift hover:border-pink-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-pink-500/20 text-center border border-gray-700/50 rounded-2xl p-6 backdrop-blur-sm bg-gray-900/30 hover:bg-gray-900/50">
            ...
            <p class="text-sm text-gray-400">Instantly download perfectly sized posts and captions for Facebook, Instagram, Twitter, LinkedIn, and more.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="testimonials" class="py-16 lg:py-24 bg-slate-800 dark:bg-white">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <!-- CTA Section -->
    <!-- FAQ Section -->
    <section id="faq" class="py-16 lg:py-24 bg-slate-800 dark:bg-white">

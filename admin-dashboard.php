            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-green-600 dark:text-green-400 mt-2">
                            <i data-lucide="trending-up" class="inline-block h-4 w-4"></i>
                            $<?= number_format($stats['revenue_this_month']) ?> this month
                        </p>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">Healthy</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                            <i data-lucide="activity" class="inline-block h-4 w-4"></i>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="user-management.php" class="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    <i data-lucide="user-plus" class="h-8 w-8 text-purple-600 dark:text-purple-400 mb-2"></i>
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Add User</span>
                </a>
                <a href="admin-events.php?pending=1" class="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    <i data-lucide="file-check" class="h-8 w-8 text-blue-600 dark:text-blue-400 mb-2"></i>
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Review Events</span>
                </a>
                <a href="admin-analytics.php" class="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                ...
                <a href="admin-settings.php" class="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="admin-logs.php" class="text-sm text-purple-600 dark:text-purple-400 hover:underline">View all</a>
                </div>
                <div class="space-y-4">
                    <?php foreach (array_slice($recentActivity, 0, 5) as $activity): ?>
                    <div class="flex items-start space-x-3">
                        <div class="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
                            <i data-lucide="activity" class="h-4 w-4 text-gray-600 dark:text-gray-400"></i>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?= htmlspecialchars($activity['user']) ?></p>
                            <p class="text-sm text-gray-600 dark:text-gray-400"><?= htmlspecialchars($activity['action']) ?></p>
                            <p class="text-xs text-gray-500 dark:text-gray-500 mt-1"><?= htmlspecialchars($activity['timestamp']) ?></p>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                        ...
                        <a href="admin-events.php?pending=1" class="underline ml-1">Review now</a>
                    </p>
                </div>
            </div>
        </div>
